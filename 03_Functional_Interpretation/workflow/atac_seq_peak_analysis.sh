...
bsub -q long -o calderon_et_al_atac_seq_peak_analysis_output.txt -e calderon_et_al_atac_seq_peak_analysis_error.txt -R"select[mem>8192] rusage[mem=8192]" -M8192 \
